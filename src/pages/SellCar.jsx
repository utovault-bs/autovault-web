...
const SellCar = () => {
  ...
  const [form, setForm] = useState({ make: '', model: '', year: '', trim: '', price: '', mileage: '', transmission: '', fuel_type: '', body_style: '', exterior_color: '', interior_color: '', engine: '', drivetrain: '', vin: '', condition: 'Used', description: '', main_image: '', images: [] });
